...
export default function Advantages() {
    const advantages = [
        ...
        {
            title: "Персонализированные рекомендации курсов",
            text: "Мы анализируем ваши интересы и цели, чтобы предложить наиболее подходящие курсы",
            icon: <FaUserCog />,
        },
        {
            title: "Доступ к эксклюзивным материалам",
            text: "Только у нас: уникальные учебные материалы и авторские методики от ведущих экспертов",
            icon: <FaBook />,
        },
    ];
    return (
